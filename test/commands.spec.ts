...
// import { authenticate, setClientName } from '../src/commands'
...
//   const command: Buffer = authenticate(0, Buffer.from(COOKIE, 'hex'))
//   t.is(command.toString('hex'), COMMAND_RESULT)
// })
...
//   const command: Buffer = setClientName(0)
//   t.is(command.toString('hex'), COMMAND_RESULT)
// })
...
//   const command: Buffer = setClientName(0, 'custom-name')
//   t.is(command.toString('hex'), COMMAND_RESULT)
// })
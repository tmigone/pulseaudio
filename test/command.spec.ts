...
import { authenticate, setClientName, getSinks, subscribe, setSinkVolume } from '../src/command'
...
const cases: PACommandTestCase[] = [
  {
    ...
    query: authenticate(0, Buffer.from(COOKIE, 'hex')),
    result: ''
  },
  {
    title: 'setClientName() command: default name',
    query: setClientName(0),
  ...
  },
  {
    ...
    query: setClientName(0, 'custom-name'),
  ...
  },
  {
    ...
    query: setSinkVolume(1, 'alsa_output.default', { channels: 2, volumes: [40000, 40000]}),

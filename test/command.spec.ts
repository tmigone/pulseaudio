...
import { PACommandList } from '../src/commands'
...
const cases: PACommandTestCase[] = [
  ...
  },
  {
    ...
    query: PACommandList.GetSinks.query(0),
  ...
  },
  {
    ...
    query: PACommandList.SetSinkVolume.query(1, 'alsa_output.default', { channels: 2, volumes: [40000, 40000]}),

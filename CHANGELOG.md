...
* client: correctly wrap some lines [SpacingBat3]
* index: export `UnixSocket` interface [SpacingBat3]
* meta: add myself to the contributors list [SpacingBat3]
* client,tests: add support for `unix:` addresses. [SpacingBat3]
